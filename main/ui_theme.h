 ...
 *
 * The large numeric faces (NUM_M/L/XL, digits only) are generated by
 * tools/gen_fonts.sh and arrive with the tile renderers -- nothing before
 * then needs type larger than 28.
 */
